...
void MyEffect::Render(bool selectFlag)
{
...
void MyEffect::DrawBox(DirectX::SimpleMath::Matrix world, DirectX::SimpleMath::Matrix view, DirectX::SimpleMath::Matrix proj)
{
	auto context = m_deviceResources->GetD3DDeviceContext();
	// 頂点情報（ここは自分で設定してください。）
	VertexPositionColorTexture vertex[4] =
	{
		VertexPositionColorTexture(Vector3(0.05f, 0.05f, 0.0f),Vector4::One, Vector2(0.0f, 0.0f)),
		VertexPositionColorTexture(Vector3(-0.05f, 0.05f, 0.0f),Vector4::One, Vector2(1.0f, 0.0f)),
		VertexPositionColorTexture(Vector3(-0.05f, -0.05f, 0.0f),Vector4::One, Vector2(1.0f, 1.0f)),
		VertexPositionColorTexture(Vector3(0.05f,-0.05f, 0.0f),Vector4::One, Vector2(0.0f, 1.0f)),
	};
